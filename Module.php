 ...
 *     'bootstrap' => ['gii'],
 *     'modules' => [
 *         'gii' => ['class' => 'aayaresko\gii\Module'],
 *     ],
 * ]
 * ~~~
 *
...
class Module extends \yii\base\Module implements BootstrapInterface
{
     ...
     * @inheritdoc
     */
    public $controllerNamespace = 'aayaresko\gii\controllers';
    /**
    ...
    public function bootstrap($app)
    {
        if ($app instanceof \yii\web\Application) {
            ...
            $app->controllerMap[$this->id] = [
                'class' => 'aayaresko\gii\console\GenerateController',
    ...
    {
        return [
            'model' => ['class' => 'aayaresko\gii\generators\model\Generator'],
            'crud' => ['class' => 'aayaresko\gii\generators\crud\Generator'],
            'controller' => ['class' => 'aayaresko\gii\generators\controller\Generator'],
            'form' => ['class' => 'aayaresko\gii\generators\form\Generator'],
            'module' => ['class' => 'aayaresko\gii\generators\module\Generator'],
            'extension' => ['class' => 'aayaresko\gii\generators\extension\Generator'],
        ];
    }
}
