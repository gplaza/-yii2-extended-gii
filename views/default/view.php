...
use aayaresko\gii\components\ActiveField;
use aayaresko\gii\CodeFile;

/* @var $this yii\web\View */
/* @var $generator aayaresko\gii\Generator */
    ...
    <?php $form = ActiveForm::begin([
        ...
        <div class="row">
            <div class="col-lg-8 col-md-10">
                ...
                ') ?>
                <?= $form->field($generator, 'templateType')->dropDownList($generator::getAvailableFileTypes()) ?>
